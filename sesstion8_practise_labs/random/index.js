...
var dataRandom = constant[Math.floor(Math.random() * constant.length)];
//console.log(constant[Math.floor(Math.random() * constant.length)]);
console.dir(dataRandom);

var quoteID = document.getElementById('quote');
var authorID = document.getElementById('author');
var reloadButton = document.getElementById('reload-button');

quoteID.innerHTML = dataRandom.quoteText;
authorID.innerHTML = dataRandom.quoteAuthor;
